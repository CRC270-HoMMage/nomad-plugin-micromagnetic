# nomad-plugin-micromagnetic

A simple plugin to demonstrate the NOMAD plugin system with micromagnetic data.
...
```sh
git clone https://github.com/CRC270-HoMMage/nomad-plugin-micromagnetic.git
cd nomad-plugin-micromagnetic
